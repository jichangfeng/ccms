        ...
        if (myeditor.mode == "wysiwyg") {
            ...
            if (!isPart) {
                ...
                for (var i = 0; i < tmpDiv.getElementsByTagName('b').length; i++) {
                    ...
                    tmpDiv.getElementsByTagName('b')[i].innerHTML = "#FormatStrongID_" + strongcount + "s#";
                    strongcount++;
                }
                ...
                for (var i = 0; i < tmpDiv.getElementsByTagName('strong').length; i++) {              
                    ...
                    tmpDiv.getElementsByTagName('strong')[i].innerHTML = "#FormatStrongID_" + strongcount + "s#";
                    strongcount++;
                }
                ...
                for (var i = 0; i < strongcount; i++) { 
                	html = html.replace("#FormatStrongID_"+i+"s#", "<strong>"+strongarray[i]+"</strong>");
                }             
