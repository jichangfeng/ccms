...
<?php elseif($Field->editor == "texttags"):?>
  <div class="form-item<?php echo isset($errors[$fieldTag]) ?' error': '';?>"<?php echo $Field->editor_shown == 0 ? ' style="display: none;"' : '';?>>
    ...
    <span class="taglist_<?php echo $fieldTag;?>" style="display: inline-block;vertical-align: top;width: 600px;">
...
<?php elseif($Field->editor == "farbtastic"):?>
  <div class="form-item<?php echo isset($errors[$fieldTag]) ?' error': '';?>"<?php echo $Field->editor_shown == 0 ? ' style="display: none;"' : '';?>>
    ...
    <div style="margin-left: 160px;padding-left: 0.5em;" id="<?php echo $fieldTag;?>control"></div>
    <?php if(isset($errors[$fieldTag])):?><span class="helpMsg"><?php echo $errors[$fieldTag];?></span><?php endif;?>
    <div class="description"><?php echo $Field->editor_help;?></div>
    <script>
      $(function(){
...
<?php elseif($Field->editor == "baidumappoint"):?>
  <div class="form-item<?php echo isset($errors[$fieldTag]) ?' error': '';?>"<?php echo $Field->editor_shown == 0 ? ' style="display: none;"' : '';?>>
    <label><?php echo $Field->name;?> <?php if($Field->required == 1):?><span title="This field is required." class="form-required">*</span><?php endif;?></label>
    <input type="hidden" style="<?php echo $Field->editor_style;?>" value="<?php echo $Data->$fieldTag;?>" name="<?php echo $fieldTag;?>" />
    <span id="<?php echo $fieldTag;?>map" style="display: inline-block;vertical-align: top;width: 600px;height: 300px;"></span>
    <?php if(isset($errors[$fieldTag])):?><span class="helpMsg"><?php echo $errors[$fieldTag];?></span><?php endif;?>
    <div class="description"><?php echo $Field->editor_help;?></div>
    <script>
      $(function(){
