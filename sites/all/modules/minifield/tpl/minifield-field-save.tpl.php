...
<?php endforeach;?>
  <fieldset id="edit-field-args" class="collapsible form-wrapper collapse-processed collapsed">
    <legend>
      <span class="fieldset-legend">
        <a href="javascript:;" onclick="Drupal.toggleFieldset(document.getElementById('edit-field-args'));" class="fieldset-title">
          <span class="fieldset-legend-prefix element-invisible">Hide</span>字段参数</a>
  ...
  <fieldset id="edit-editor-args" class="collapsible form-wrapper collapse-processed collapsed">
    <legend>
      <span class="fieldset-legend">
        <a href="javascript:;" onclick="Drupal.toggleFieldset(document.getElementById('edit-editor-args'));" class="fieldset-title">
          <span class="fieldset-legend-prefix element-invisible">Hide</span>编辑控件参数</a>
        <span class="summary">慎重修改</span>
      </span>
    </legend>
    <div class="fieldset-wrapper" style="display: none;">
