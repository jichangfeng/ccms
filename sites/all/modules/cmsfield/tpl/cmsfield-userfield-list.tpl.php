<div id="crumbs">
  <a href="<?php echo base_path().'cmsfield/userfield/'.$Category->id.'/list';?>"><?php echo $Category->name;?></a> <em>›</em> <?php echo ts('列表', 'ucwords', 'default');?>
</div>
<div class="cdata">
  ...
  <table>
    ...
    <?php if(isset($arrDatas)):?>
      <?php
        $canEditData = cmsMenuAccessCheck('cmsfield/userfield/'.$Category->id.'/%/edit');
      ?>
      ...
      <tr class="<?php echo $key % 2 == 0 ? 'even' : 'odd';?>">
        ...
        <?php if(isset($arrFields)):?>
          ...
          <?php endforeach;?>
          <td>
            <?php if($canEditData && $Data->fieldname != 'userid'):?>
            <a class="ico-button ico-edit" href="<?php echo base_path().'cmsfield/userfield/'.$Category->id.'/'.$Data->id.'/edit';?>"><?php echo ts('编辑', 'ucwords', 'default');?></a>
            <?php endif;?>
          </td>
        <?php endif;?>
      </tr>
