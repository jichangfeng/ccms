<div id="crumbs">
  <a href="<?php echo base_path().'cmsfield/category/list';?>"><?php echo $Category->name;?></a> <em>›</em> <?php echo ts('编辑', 'ucwords', 'default');?>
</div>
  ...
  <div class="formArea">
    ...
    <div class="formEle">
      ...
      <fieldset id="edit-table-args" class="collapsible form-wrapper collapse-processed collapsed">
        <legend>
          <a href="javascript:;" onclick="$('#edit-table-args .fieldset-wrapper').toggle('slow');">表参数</a>
