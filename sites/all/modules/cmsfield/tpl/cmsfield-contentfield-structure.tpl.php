<div id="crumbs">
  <a href="<?php echo base_path().'cmsfield/contentfield';?>"><?php echo ts('网站内容字段', 'ucwords', 'default');?></a> <em>›</em> <?php echo ts('字段结构树', 'ucwords', 'cmsfield');?>
</div>
<div class="cdata">
  ...
  <div>
    ...
    <div class="grouptags">
      ...
      <div class="grouplist">
        ...
        <a href="<?php echo base_path().'cmsfield/contentfield/'.$Category->id.'/list';?>"><?php echo $Category->name;?></a>
        <?php endforeach;?>
      </div>
    </div>
    <?php endforeach;?>
