<div id="crumbs">
  <a href="<?php echo base_path().'cmsnode/'.$Navigation->id.'/list';?>"><?php echo $Navigation->name;?></a> <em>›</em> <?php echo ts('内容编辑', 'ucwords', 'node');?>
</div>
<?php $arrHtmlCssJs = array();?>
<form style="width: 100%;margin: 0 auto;" method="post" action="<?php echo $action;?>" enctype="multipart/form-data">
  <div class="formArea">
    <div class="formTit"><?php echo $Navigation->name;?> - <?php echo ts('内容编辑', 'ucwords', 'node');?></div>
    <div class="formEle">
